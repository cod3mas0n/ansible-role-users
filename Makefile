...
## —— Bootstrap ——————————————————————————————————————————————————————————————————————————————————
.PHONY: bootstrap
bootstrap: ## Bootstrap Ansible role
	$(MAKE) python-bootstrap

.PHONY: bootstrap-dev
bootstrap-dev: ## Bootstrap Ansible role for development
	$(MAKE) bootstrap
	$(MAKE) python-bootstrap-dev

## —— Virtualenv —————————————————————————————————————————————————————————————————————————————————
.PHONY: reinitialization
reinitialization: ## Return to initial state of Bootstrap Ansible role
	$(MAKE) clean
	$(MAKE) bootstrap

.PHONY: reinitialization-dev
reinitialization-dev: ## Return to initial state of Bootstrap Ansible role for development
